# [西门子S7系列PLC通讯](http://snap7.sourceforge.net/)

[snap7](https://sourceforge.net/projects/snap7/files/1.4.2/snap7-full-1.4.2.7z/download)

## snap7.net源码解析

:::: code-group
::: code-group-item S7Consts
