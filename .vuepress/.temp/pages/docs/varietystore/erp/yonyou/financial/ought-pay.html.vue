<template><h1 id="应付单" tabindex="-1"><a class="header-anchor" href="#应付单" aria-hidden="true">#</a> 应付单</h1>
<ul>
<li>
<p>资源符</p>
<p><strong>oughtpay</strong></p>
</li>
<li>
<p>操作符</p>
<ul>
<li>
<p><strong>create</strong> <Badge type="tip" text="v1" vertical="top" /></p>
</li>
<li>
<p><strong>load</strong> <Badge type="tip" text="v2" vertical="top" /></p>
</li>
<li>
<p><strong>edit</strong> <Badge type="tip" text="v2" vertical="top" /></p>
</li>
<li>
<p><strong>delete</strong> <Badge type="tip" text="v2" vertical="top" /></p>
</li>
</ul>
</li>
<li>
...
<CodeGroup>
<CodeGroupItem title="请求">
<div class="language-json ext-json line-numbers-mode"><pre v-pre class="language-json"><code><span class="token punctuation">{</span>
    <span class="token property">"oughtpay"</span><span class="token operator">:</span> <span class="token punctuation">{</span>
    <span class="token property">"vouchertype"</span><span class="token operator">:</span> <span class="token string">"P0"</span><span class="token punctuation">,</span>
    <span class="token property">"date"</span><span class="token operator">:</span> <span class="token string">"2015-01-01"</span><span class="token punctuation">,</span>
    <span class="token property">"cust_vendor_code"</span><span class="token operator">:</span> <span class="token string">"03006"</span><span class="token punctuation">,</span>
    <span class="token property">"deptcode"</span><span class="token operator">:</span> <span class="token string">"0403"</span><span class="token punctuation">,</span>
    <span class="token property">"personcode"</span><span class="token operator">:</span> <span class="token string">"00044"</span><span class="token punctuation">,</span>
    <span class="token property">"subjectcode"</span><span class="token operator">:</span> <span class="token string">"220202"</span><span class="token punctuation">,</span>
    <span class="token property">"currency_name"</span><span class="token operator">:</span> <span class="token string">"人民币"</span><span class="token punctuation">,</span>
    <span class="token property">"currency_rate"</span><span class="token operator">:</span> <span class="token string">"1"</span><span class="token punctuation">,</span>
    <span class="token property">"bdebitcredit"</span><span class="token operator">:</span> <span class="token string">"0"</span><span class="token punctuation">,</span>
    <span class="token property">"natamount"</span><span class="token operator">:</span> <span class="token string">"2530"</span><span class="token punctuation">,</span>
    <span class="token property">"amount"</span><span class="token operator">:</span> <span class="token string">"2530"</span><span class="token punctuation">,</span>
    <span class="token property">"paycondition_code"</span><span class="token operator">:</span> <span class="token string">"01"</span><span class="token punctuation">,</span>
    <span class="token property">"operator"</span><span class="token operator">:</span> <span class="token string">"demo"</span><span class="token punctuation">,</span>
    <span class="token property">"flag"</span><span class="token operator">:</span> <span class="token string">"AP"</span><span class="token punctuation">,</span>
    <span class="token property">"quantity"</span><span class="token operator">:</span> <span class="token string">"10"</span><span class="token punctuation">,</span>
    <span class="token property">"startflag"</span><span class="token operator">:</span> <span class="token string">"0"</span><span class="token punctuation">,</span>
    <span class="token property">"entry"</span><span class="token operator">:</span> <span class="token punctuation">{</span>
        ...
        <span class="token property">"currency_name"</span><span class="token operator">:</span> <span class="token string">"人民币"</span><span class="token punctuation">,</span>
        <span class="token property">"currency_rate"</span><span class="token operator">:</span> <span class="token string">"1"</span><span class="token punctuation">,</span>
        <span class="token property">"bdebitcredit"</span><span class="token operator">:</span> <span class="token string">"1"</span><span class="token punctuation">,</span>
        <span class="token property">"natamount"</span><span class="token operator">:</span> <span class="token string">"2530"</span><span class="token punctuation">,</span>
        <span class="token property">"amount"</span><span class="token operator">:</span> <span class="token string">"2530"</span>
...
<CodeGroupItem title="响应">
<div class="language-json ext-json line-numbers-mode"><pre v-pre class="language-json"><code><span class="token punctuation">{</span>
    <span class="token property">"errcode"</span><span class="token operator">:</span> <span class="token string">"0"</span><span class="token punctuation">,</span>
    ...
    <span class="token property">"tradeid"</span><span class="token operator">:</span> <span class="token string">"3eb76146-c94b-4b4b-87ef-40ac1087f9ba"</span>
<span class="token punctuation">}</span>
...
<details class="custom-container details"><summary>查看演示</summary>
<p><a href="http://47.117.141.19/gif/oughtpay.gif" target="_blank" rel="noopener noreferrer">进入传送门<ExternalLinkIcon/></a></p>
</details>
</template>
