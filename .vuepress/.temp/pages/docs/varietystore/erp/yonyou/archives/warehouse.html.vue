<template><h1 id="仓库档案" tabindex="-1"><a class="header-anchor" href="#仓库档案" aria-hidden="true">#</a> 仓库档案</h1>
<ul>
<li>
<p>资源符</p>
<p>warehouse</p>
...
<div class="language-json ext-json line-numbers-mode"><pre v-pre class="language-json"><code><span class="token punctuation">{</span>
    <span class="token property">"warehouse"</span><span class="token operator">:</span> <span class="token punctuation">{</span>
        ...
        <span class="token property">"name"</span><span class="token operator">:</span> <span class="token string">"测试仓"</span><span class="token punctuation">,</span>
        <span class="token property">"valuestyle"</span><span class="token operator">:</span> <span class="token string">"全月平均法"</span><span class="token punctuation">,</span>
        <span class="token property">"cFactoryCode"</span><span class="token operator">:</span> <span class="token string">"001"</span>
...
<p><a href="/images/erp/gif/warehouse.gif">进入传送门</a></p>
</details>
</template>
