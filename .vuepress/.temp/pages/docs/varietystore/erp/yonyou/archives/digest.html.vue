<template><h1 id="常用摘要" tabindex="-1"><a class="header-anchor" href="#常用摘要" aria-hidden="true">#</a> 常用摘要</h1>
<ul>
<li>
<p>资源符</p>
<p>digest</p>
...
<div class="language-json ext-json line-numbers-mode"><pre v-pre class="language-json"><code><span class="token punctuation">{</span>
    <span class="token property">"digest"</span><span class="token operator">:</span> <span class="token punctuation">{</span>
        ...
        <span class="token property">"text"</span><span class="token operator">:</span> <span class="token string">"产品销售收入"</span><span class="token punctuation">,</span>
        <span class="token property">"subjectcode"</span><span class="token operator">:</span> <span class="token string">"2181"</span>
...
<p><a href="/images/erp/gif/digest.gif">进入传送门</a></p>
</details>
</template>
