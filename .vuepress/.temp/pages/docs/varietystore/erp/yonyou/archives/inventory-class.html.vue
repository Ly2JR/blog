<template><h1 id="存货分类" tabindex="-1"><a class="header-anchor" href="#存货分类" aria-hidden="true">#</a> 存货分类</h1>
<ul>
<li>
<p>资源符</p>
<p>inventoryclass</p>
...
<div class="language-json ext-json line-numbers-mode"><pre v-pre class="language-json"><code><span class="token punctuation">{</span>
    <span class="token property">"inventoryclass"</span><span class="token operator">:</span><span class="token punctuation">{</span>
        <span class="token property">"code"</span><span class="token operator">:</span><span class="token string">"99"</span><span class="token punctuation">,</span>
        <span class="token property">"name"</span><span class="token operator">:</span><span class="token string">"存货分类"</span><span class="token punctuation">,</span>
        ...
        <span class="token property">"end_rank_flag"</span><span class="token operator">:</span><span class="token number">1</span><span class="token punctuation">,</span>
...
<p><a href="/images/erp/gif/inventoryclass.gif">进入传送门</a></p>
</details>
</template>
