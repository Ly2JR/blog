<template><h1 id="银行档案" tabindex="-1"><a class="header-anchor" href="#银行档案" aria-hidden="true">#</a> 银行档案</h1>
<ul>
<li>
<p>资源符</p>
<p>aa_bank</p>
...
<div class="language-json ext-json line-numbers-mode"><pre v-pre class="language-json"><code><span class="token punctuation">{</span>
    <span class="token property">"aa_bank"</span><span class="token operator">:</span> <span class="token punctuation">{</span>
        ...
        <span class="token property">"name"</span><span class="token operator">:</span> <span class="token string">"中国南京银行"</span><span class="token punctuation">,</span>
        <span class="token property">"bindfixlen"</span><span class="token operator">:</span> <span class="token string">"0"</span><span class="token punctuation">,</span>
        <span class="token property">"iindaccnolen"</span><span class="token operator">:</span> <span class="token string">"11"</span><span class="token punctuation">,</span>
        <span class="token property">"iindautoinputlen"</span><span class="token operator">:</span> <span class="token string">"0"</span><span class="token punctuation">,</span>
        <span class="token property">"bcomdfixlen"</span><span class="token operator">:</span> <span class="token string">"0"</span><span class="token punctuation">,</span>
...
<p><a href="/images/erp/gif/aa_bank.gif">进入传送门</a></p>
</details>
</template>
