<template><h1 id="原因码档案" tabindex="-1"><a class="header-anchor" href="#原因码档案" aria-hidden="true">#</a> 原因码档案</h1>
<ul>
<li>
<p>资源符</p>
<p>reason</p>
...
<div class="language-json ext-json line-numbers-mode"><pre v-pre class="language-json"><code><span class="token punctuation">{</span>
    <span class="token property">"reason"</span><span class="token operator">:</span> <span class="token punctuation">{</span>
        ...
        <span class="token property">"name"</span><span class="token operator">:</span> <span class="token string">"无原因"</span><span class="token punctuation">,</span>
        <span class="token property">"Reasontype"</span><span class="token operator">:</span> <span class="token string">"3"</span>
...
<p><a href="/images/erp/gif/reason.gif">进入传送门</a></p>
</details>
</template>
