<template><h1 id="存货自由项对照表" tabindex="-1"><a class="header-anchor" href="#存货自由项对照表" aria-hidden="true">#</a> 存货自由项对照表</h1>
<ul>
<li>
<p>资源符</p>
<p>invandfree</p>
...
<div class="language-json ext-json line-numbers-mode"><pre v-pre class="language-json"><code><span class="token punctuation">{</span>
    <span class="token property">"invandfree"</span><span class="token operator">:</span> <span class="token punctuation">{</span>
        ...
        <span class="token property">"cudid"</span><span class="token operator">:</span> <span class="token string">"34"</span><span class="token punctuation">,</span>
        <span class="token property">"cudvalue"</span><span class="token operator">:</span> <span class="token string">"黑色"</span>
...
<p><a href="/images/erp/gif/invandfree.gif">进入传送门</a></p>
</details>
</template>
