<template><h1 id="凭证类别" tabindex="-1"><a class="header-anchor" href="#凭证类别" aria-hidden="true">#</a> 凭证类别</h1>
<ul>
<li>
<p>资源符</p>
<p>dsign</p>
...
<div class="language-json ext-json line-numbers-mode"><pre v-pre class="language-json"><code><span class="token punctuation">{</span>
    <span class="token property">"dsign"</span><span class="token operator">:</span> <span class="token punctuation">{</span>
        <span class="token property">"type"</span><span class="token operator">:</span> <span class="token string">"贷"</span><span class="token punctuation">,</span>
        <span class="token property">"order_code"</span><span class="token operator">:</span> <span class="token string">"1"</span><span class="token punctuation">,</span>
        <span class="token property">"type_name"</span><span class="token operator">:</span> <span class="token string">"贷款凭证"</span>
...
<p><a href="/images/erp/gif/dsign.gif">进入传送门</a></p>
</details>
</template>
