<template><h1 id="存货货位对照表" tabindex="-1"><a class="header-anchor" href="#存货货位对照表" aria-hidden="true">#</a> 存货货位对照表</h1>
<ul>
<li>
<p>资源符</p>
<p>invandpos</p>
...
<div class="language-json ext-json line-numbers-mode"><pre v-pre class="language-json"><code><span class="token punctuation">{</span>
    <span class="token property">"invandpos"</span><span class="token operator">:</span> <span class="token punctuation">{</span>
        <span class="token property">"cinvcode"</span><span class="token operator">:</span> <span class="token string">"01019002063"</span><span class="token punctuation">,</span>
        <span class="token property">"cposcode"</span><span class="token operator">:</span> <span class="token string">"40-G-0-0-0"</span><span class="token punctuation">,</span>
        <span class="token property">"iprior"</span><span class="token operator">:</span> <span class="token string">"1"</span>
...
<p><a href="/images/erp/gif/invandpos.gif">进入传送门</a></p>
</details>
</template>
