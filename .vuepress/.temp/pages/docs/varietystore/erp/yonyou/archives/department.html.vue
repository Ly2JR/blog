<template><h1 id="部门档案" tabindex="-1"><a class="header-anchor" href="#部门档案" aria-hidden="true">#</a> 部门档案</h1>
<ul>
<li>
<p>资源符</p>
<p>department</p>
...
<div class="language-json ext-json line-numbers-mode"><pre v-pre class="language-json"><code><span class="token punctuation">{</span>
    <span class="token property">"department"</span><span class="token operator">:</span><span class="token punctuation">{</span>
        ...
        <span class="token property">"endflag"</span><span class="token operator">:</span><span class="token number">1</span><span class="token punctuation">,</span>
        <span class="token property">"ddepbegindate"</span><span class="token operator">:</span><span class="token string">"2015-12-01"</span>
...
<p><a href="/images/erp/gif/department.gif">进入传送门</a></p>
</details>
</template>
