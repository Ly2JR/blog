<template><h1 id="职务类别" tabindex="-1"><a class="header-anchor" href="#职务类别" aria-hidden="true">#</a> 职务类别</h1>
<ul>
<li>
<p>资源符</p>
<p>dutytype</p>
...
<div class="language-json ext-json line-numbers-mode"><pre v-pre class="language-json"><code><span class="token punctuation">{</span>
    <span class="token property">"dutytype"</span><span class="token operator">:</span> <span class="token punctuation">{</span>
        ...
        <span class="token property">"name"</span><span class="token operator">:</span> <span class="token string">"运维职务"</span><span class="token punctuation">,</span>
        <span class="token property">"simplename"</span><span class="token operator">:</span> <span class="token string">"运维职务"</span><span class="token punctuation">,</span>
        <span class="token property">"simplespell"</span><span class="token operator">:</span> <span class="token string">"YWZW"</span><span class="token punctuation">,</span>
...
<p><a href="/images/erp/gif/dutytype.gif">进入传送门</a></p>
</details>
</template>
