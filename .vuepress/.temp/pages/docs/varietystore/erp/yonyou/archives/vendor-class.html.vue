<template><h1 id="供应商分类" tabindex="-1"><a class="header-anchor" href="#供应商分类" aria-hidden="true">#</a> 供应商分类</h1>
<ul>
<li>
<p>资源符</p>
<p>vendorclass</p>
...
<div class="language-json ext-json line-numbers-mode"><pre v-pre class="language-json"><code><span class="token punctuation">{</span>
    <span class="token property">"vendorclass"</span><span class="token operator">:</span><span class="token punctuation">{</span>
        <span class="token property">"code"</span><span class="token operator">:</span><span class="token string">"98"</span><span class="token punctuation">,</span>
        <span class="token property">"name"</span><span class="token operator">:</span><span class="token string">"测试分类98"</span><span class="token punctuation">,</span>
        ...
        <span class="token property">"end_rank_flag"</span><span class="token operator">:</span><span class="token string">"1"</span>
...
<p><a href="/images/erp/gif/vendorclass.gif">进入传送门</a></p>
</details>
</template>
