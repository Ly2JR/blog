<template><h1 id="客户分类" tabindex="-1"><a class="header-anchor" href="#客户分类" aria-hidden="true">#</a> 客户分类</h1>
<ul>
<li>
<p>资源符</p>
<p>customerclass</p>
...
<div class="language-json ext-json line-numbers-mode"><pre v-pre class="language-json"><code><span class="token punctuation">{</span>
    <span class="token property">"customerclass"</span><span class="token operator">:</span><span class="token punctuation">{</span>
...
<p><a href="/images/erp/gif/customerclass.gif">进入传送门</a></p>
</details>
</template>
