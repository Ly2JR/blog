<template><h1 id="计量单位组" tabindex="-1"><a class="header-anchor" href="#计量单位组" aria-hidden="true">#</a> 计量单位组</h1>
<ul>
<li>
<p>资源符</p>
<p>unitgroup</p>
...
<td style="text-align:left"></td>
<td style="text-align:left">是</td>
<td style="text-align:left">组类别(0:固定；1：浮动)</td>
</tr>
<tr>
...
<div class="language-json ext-json line-numbers-mode"><pre v-pre class="language-json"><code><span class="token punctuation">{</span>
    <span class="token property">"unitgroup"</span><span class="token operator">:</span> <span class="token punctuation">{</span>
        ...
        <span class="token property">"name"</span><span class="token operator">:</span> <span class="token string">"公斤"</span><span class="token punctuation">,</span>
        ...
        <span class="token property">"cgrprelinvcode"</span><span class="token operator">:</span> <span class="token string">""</span>
...
<p><a href="/images/erp/gif/unitgroup.gif">进入传送门</a></p>
</details>
</template>
