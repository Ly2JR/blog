<template><h1 id="费用项目" tabindex="-1"><a class="header-anchor" href="#费用项目" aria-hidden="true">#</a> 费用项目</h1>
<ul>
<li>
<p>资源符</p>
<p>expenseitem</p>
...
<div class="language-json ext-json line-numbers-mode"><pre v-pre class="language-json"><code><span class="token punctuation">{</span>
    <span class="token property">"expenseitem"</span><span class="token operator">:</span> <span class="token punctuation">{</span>
        <span class="token property">"code"</span><span class="token operator">:</span> <span class="token string">"60"</span><span class="token punctuation">,</span>
        <span class="token property">"name"</span><span class="token operator">:</span> <span class="token string">"员工培训"</span><span class="token punctuation">,</span>
        <span class="token property">"cexpccode"</span><span class="token operator">:</span> <span class="token string">"6"</span>
...
<p><a href="/images/erp/gif/expenseitem.gif">进入传送门</a></p>
</details>
</template>
